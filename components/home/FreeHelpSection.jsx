...
const items = [
  {
    id: 1,
    icon: <Mic size={30} className="text-[var(--orange)]" />,
    title: "Podcast",
    desc: "Catch the best stories of resilience, success, and growth on The Arnav Patil Podcast, where leaders reveal how they built empires from scratch.",
    btn: "Watch & Listen",
  },
  {
    id: 2,
  ...
  {
    id: 3,
    icon: <Monitor size={30} className="text-[var(--orange)]" />,
    title: "Watch",
    ...
    <section className="w-full py-16 sm:py-20 lg:py-28 bg-[var(--off-white)]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <motion.h2
          ...
          className="font-montserrat font-black text-[var(--dark)] leading-tight mb-4"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 lg:gap-16">
          ...
          {items.map((item, i) => (
            ...
            >
              ...
              {/* Description */}
              <p className="text-[var(--gray)] font-inter text-sm leading-relaxed mb-6 max-w-xs">
                {item.desc}
              </p>
