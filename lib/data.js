...
export const coachInfo = {
  ...
  facebook : "https://www.facebook.com/coacharnavpatil",
...
export const programs = [
  {
    ...
    icon: "💎",
    duration: "2 Days",
    mode: "Offline", // Changed from "Offline / Live" to specific category
    category: "Live", // Add category field: "Recorded" or "Live"
    language: "Marathi & Hindi",
    audience: "Jewellery business owners, retailers, manufacturers",
    description:
      "India's most impactful programme specifically designed for jewellery business owners. Learn proven systems to automate operations, double sales, and build a brand that lasts generations. Over 1000+ jewellers have transformed their businesses through this masterclass.",
  ...
  },
  {
    ...
    duration: "3 Months",
    mode: "Online & Offline",
    category: "Recorded", // Recorded program
    language: "Marathi, Hindi & English",
    audience: "Business owners across all sectors",
    description:
      "A comprehensive 3-month coaching programme helping business owners in all sectors systematize, scale, and lead their businesses like a true CEO. Covers strategy, systems, people, and profit.",
  ...
  link: "/programs",
  shortTitle: "Marketing Bootcamp",
  tagline: "Master Digital Growth & Dominate Online",
  badge: "Trending",
  icon: "📈",
  duration: "2 Days",
  mode: "Online",
  category: "Recorded",
  language: "Marathi, Hindi & English",
  audience: "Business owners, marketers, freelancers, students",
  description:
    "An intensive bootcamp designed to help you master digital marketing strategies that actually work. Learn how to generate leads, increase conversions, and scale your business using proven online techniques.",
  highlights: [
  ...
  testimonialIds: [1, 3],
  image: "/programms/arnav_patil_programm_05.webp",
},
{
  slug: "startup-foundation-program",
  title: "Startup Foundation Program",
  link: "/programs",
  shortTitle: "Startup Program",
  tagline: "Build Your Startup from Idea to Execution",
  ...
  category: "Live",
  language: "Marathi, Hindi & English",
  audience: "Aspiring entrepreneurs, students, startup founders",
  description:
    "A step-by-step program designed for aspiring entrepreneurs who want to turn their ideas into successful businesses. Learn validation, execution, and scaling fundamentals from scratch.",
  highlights: [
    ...
    "Scaling & growth hacks",
  ],
  testimonialIds: [2, 4],
  image: "/programms/arnav_patil_programm_06.webp",
}
...
export const whyChoose = [
  ...
  },
  {
   ...
   {
    icon: "💎",
    title: "Legacy and Family Business Expert",
    desc: "Leading the Legacy Business Sector as the go-to coach for family-run business owners across India.",
  },
];
...
export const blogPosts = [
  ...
  {
  slug: "why-most-businesses-fail-within-5-years",
  title: "Why Most Businesses Fail Within 5 Years (And How Yours Won't)",
  excerpt: "Statistics show that 50% of businesses fail within 5 years. Here's the real reason why — and the exact framework to ensure your business survives and thrives.",
  date: "2025-03-25",
  readTime: "7 min",
  category: "Business Strategy",
  tags: ["business failure", "sustainability", "business growth", "strategy"],
  image: "https://placehold.co/600x400/0891B2/white?text=Business+Failure",
  content: [
    {
      type: "intro",
      text: "The numbers are sobering. According to recent data, about 50% of businesses fail within their first five years. But here's what most people don't understand: businesses don't fail because of bad luck or lack of effort. They fail because of predictable, avoidable mistakes. And once you know what those mistakes are, you can ensure your business isn't part of that statistic.",
    },
    {
      type: "heading",
      text: "Mistake #1: No Clear Business Model",
    },
    {
      type: "paragraph",
      text: "Many business owners start with a product or service idea without thinking through how they'll consistently acquire customers, deliver value, and generate profit. A business without a clear, repeatable model isn't a business — it's an expensive hobby.",
    },
    {
      type: "heading",
      text: "Mistake #2: Running Out of Cash",
    },
    {
      type: "paragraph",
      text: "Cash flow is the lifeblood of any business. The most successful businesses plan their finances carefully, maintain healthy reserves, and understand exactly when they'll break even. They don't rely on hope — they rely on numbers.",
    },
    {
      type: "heading",
      text: "Mistake #3: Ignoring Customer Feedback",
    },
    {
      type: "paragraph",
      text: "Your customers are your best source of insight. Businesses that fail often do so because they stop listening to what their customers actually want. The businesses that thrive are constantly gathering feedback, iterating, and improving based on real data — not assumptions.",
    },
    {
      type: "callout",
      text: "Want a free business health check? Connect with Arnav Patil for a no-obligation consultation and find out exactly where your business stands.",
    },
  ],
},
{
  slug: "power-of-branding-for-small-businesses",
  title: "The Power of Branding for Small Businesses",
  excerpt: "You don't need a huge budget to build a memorable brand. Here's how small businesses can compete with the big players through smart branding strategies.",
  date: "2025-03-18",
  readTime: "6 min",
  category: "Branding",
  tags: ["branding", "small business", "marketing", "positioning"],
  image: "https://placehold.co/600x400/F97316/white?text=Branding",
  content: [
    {
      type: "intro",
      text: "When small business owners hear the word 'branding,' they often imagine expensive ad campaigns and celebrity endorsements. But real branding isn't about budget — it's about clarity, consistency, and connection. Here's how to build a brand that customers love, remember, and trust.",
    },
    {
      type: "heading",
      text: "What Branding Really Means",
    },
    {
      type: "paragraph",
      text: "Your brand is not your logo, your colors, or your website. Your brand is the feeling people get when they interact with your business. It's the promise you make and keep. It's what people say about you when you're not in the room.",
    },
    {
      type: "heading",
      text: "Step 1: Define Your Core Message",
    },
    {
      type: "paragraph",
      text: "Before you design anything, get clear on what you stand for. What problem do you solve? Why should customers choose you over anyone else? What's the one thing you want to be known for? Answer these questions first.",
    },
    {
      type: "heading",
      text: "Step 2: Be Consistent Everywhere",
    },
    {
      type: "paragraph",
      text: "Consistency builds trust. Use the same colors, fonts, tone of voice, and messaging across your website, social media, packaging, and customer service. When customers see the same look and feel everywhere, they start to recognise and remember you.",
    },
    {
      type: "callout",
      text: "Ready to build a brand that stands out? Join Arnav Patil's Brand Building Masterclass and get a step-by-step framework tailored for small businesses.",
    },
  ],
},
{
  slug: "how-to-hire-right-team-for-business-growth",
  title: "How to Hire the Right Team for Business Growth",
  excerpt: "Your business will only grow as fast as your team. Here's a practical guide to hiring people who will help you scale — not hold you back.",
  date: "2025-03-10",
  readTime: "8 min",
  category: "Team Building",
  tags: ["hiring", "team building", "recruitment", "business growth"],
  image: "https://placehold.co/600x400/0891B2/white?text=Hiring",
  content: [
    {
      type: "intro",
      text: "The single biggest constraint on business growth is often not money, not market, not product — it's people. You cannot scale a business alone. At some point, you need to hire a team that shares your vision, executes with excellence, and frees you up to focus on higher-level strategy.",
    },
    {
      type: "heading",
      text: "The Cost of a Bad Hire",
    },
    {
      type: "paragraph",
      text: "A bad hire costs far more than just salary. There's the time spent recruiting and training, the lost productivity, the impact on team morale, and the potential damage to customer relationships. One wrong person can set your business back months.",
    },
    {
      type: "heading",
      text: "The 5-Step Hiring Framework",
    },
    {
      type: "list",
      items: [
        "Define the role clearly — write down specific responsibilities and outcomes",
        "Look for attitude first, skills second — you can teach skills, you can't teach character",
        "Use a trial project before committing — see how they actually work",
        "Check references thoroughly — talk to people who've worked with them",
        "Onboard properly — don't just throw them in and hope for the best"
      ],
    },
    {
      type: "heading",
      text: "Where to Find Great People",
    },
    {
      type: "paragraph",
      text: "The best hires often come from referrals from people you trust. Also look at industry communities, LinkedIn, and even your own customer base. Sometimes the person who loves your business from the outside is the perfect person to join your team.",
    },
    {
      type: "callout",
      text: "Struggling to find the right people? Arnav Patil's Team Building Program includes hiring templates, interview guides, and onboarding systems that have helped hundreds of business owners build winning teams.",
    },
  ],
}
];
